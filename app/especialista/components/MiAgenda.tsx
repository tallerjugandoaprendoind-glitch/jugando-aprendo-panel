  ...
  return status === 'connected' ? (
    ...
    <button
      ...
      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all disabled:opacity-50
        ...
        dark:bg-[#21262d] dark:text-slate-300 dark:border-[#30363d]
...
const STATUS_CFG: Record<string, {
  ...
  confirmed: {
    ...
    badgeDark: 'dark:bg-emerald-900/40 dark:text-emerald-400 dark:border-emerald-800',
    bar:       '#10b981',
  },
  pending: {
    label:     'Pendiente',
    ...
    badgeDark: 'dark:bg-amber-900/40 dark:text-amber-400 dark:border-amber-800',
    bar:       '#f59e0b',
  },
  cancelled: {
    label:     'Cancelada',
    ...
    badgeDark: 'dark:bg-red-900/40 dark:text-red-400 dark:border-red-800',
    bar:       '#ef4444',
  },
  completed: {
    label:     'Completada',
    ...
    badgeDark: 'dark:bg-blue-900/40 dark:text-blue-400 dark:border-blue-800',
    bar:       '#3b82f6',
  },
}
...
export default function MiAgenda() {
  ...
  /* ── Helpers de clase ── */
  const card   = 'bg-white dark:bg-[#161b22] border border-slate-200 dark:border-[#21262d] shadow-sm'
  const divider = 'border-slate-50 dark:border-[#21262d]'
  ...
  return (
    <div className="space-y-5 pb-20 md:pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
        ...
        {/* ════ CALENDARIO ════ */}
        <div className={`lg:col-span-3 ${card} rounded-2xl overflow-hidden`}>
          ...
          <div className={`flex items-center justify-between px-6 py-4 border-b ${divider}`}>
            <button
              ...
              className="w-8 h-8 rounded-lg flex items-center justify-center
                ...
                hover:bg-slate-100 dark:hover:bg-[#21262d] transition-colors"
            >
              <ChevronLeft size={16} />
            </button>
            ...
            <h3 className="font-black text-base text-slate-800 dark:text-slate-100">
              {MESES[mesN]}{' '}
              <span className="font-semibold text-slate-400 dark:text-slate-500">{año}</span>
            </h3>
          ...
          {/* Cabecera días */}
          <div className={`grid grid-cols-7 border-b ${divider}`}>
            {DIAS_CORTO.map((d, i) => (
              <div
                key={i}
                className="text-center py-3 text-[11px] font-black uppercase tracking-wider
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      pt-2 pb-1.5 px-1 rounded-xl min-h-[64px]
                      transition-all group
                      ${esSel
                        ? 'bg-blue-600 shadow-md shadow-blue-200 dark:shadow-blue-900/50'
                        : esHoy
                          ? 'bg-blue-50 dark:bg-blue-950/40 border-2 border-blue-300 dark:border-blue-700'
                          : tieneCitas
                            ? 'bg-slate-50 dark:bg-[#1c2128] border border-slate-100 dark:border-[#21262d] hover:bg-slate-100 dark:hover:bg-[#21262d]'
                      ...
                      <div className="flex flex-col gap-0.5 w-full px-0.5">
                        {citasDia.slice(0, 2).map((c, idx) => {
                          ...
                          return (
                            <div
                              key={idx}
                              className={`w-full h-1.5 rounded-full ${esSel ? 'bg-white/40' : cfg.dot}`}
                            />
                          )
                        })}
                        {citasDia.length > 2 && (
                          <span className={`text-[9px] font-black text-center
                            ${esSel ? 'text-white/70' : 'text-slate-400 dark:text-slate-500'}`}>
                            +{citasDia.length - 2}
                          </span>
                        )}
                      </div>
          ...
          {/* Leyenda */}
          <div className={`px-5 py-3 border-t ${divider} flex items-center gap-4 flex-wrap`}>
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className={`${card} rounded-2xl overflow-hidden flex flex-col`}>
            ...
            <div className={`px-5 py-4 border-b ${divider} flex items-center gap-3`}>
              ...
              <span className="text-xs font-black px-2.5 py-1 rounded-full flex-shrink-0
                text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-[#21262d]">
                    ...
                    return (
                      <div
                        ...
                        className="px-5 py-3.5 flex items-center gap-3
                          hover:bg-slate-50/70 dark:hover:bg-[#1c2128] transition-colors"
                      >
                        <div
                        ...
                        />
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-black truncate text-slate-800 dark:text-slate-100">
                            {c.children?.name}
                          </p>
          ...
          {/* ── Próximas citas ── */}
          <div className={`${card} rounded-2xl overflow-hidden flex-1`}>
            ...
            <div className={`px-5 py-4 border-b ${divider} flex items-center gap-3`}>
              ...
              <h3 className="font-black text-sm flex-1 text-slate-800 dark:text-slate-100">
                Próximas citas
              </h3>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs flex items-center gap-1 mt-0.5 text-slate-400 dark:text-slate-500">
                          ...
                          {c.appointment_time?.slice(0,5)}
                          {esHoyItem && (
                            <span className="font-black text-blue-600 dark:text-blue-400">· Hoy</span>
                          )}
                        </p>
                      </div>
