...
const getVideos = (isEN: boolean) => [
  {
    ...
    desc: 'Learn the methodology we use in each session',
  },
  {
    url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
...
export default function LandingPage() {
  ...
  const testimonials = [
    { name: 'María G.', desc: 'Rodrigo\'s mom, 6 years · ASD Level 2', a: 'M', color: '#f97316', text: 'En 3 meses mi hijo empezó a comunicarse con frases completas. Los reportes con IA nos ayudan a entender su progreso sin tecnicismos. ¡Los recomiendo al 100%!' },
    { name: 'Carlos R.', desc: 'Valentina\'s dad, 4 years · ADHD', a: 'C', color: '#10b981', text: 'Lo que más me sorprendió fue poder seguir el avance semana a semana desde mi celular. El asistente IA nos da consejos para trabajar en casa. Valentina ha mejorado muchísimo.' },
    { name: 'Rosa T.', desc: 'Mateo\'s mom, 5 years · ASD Level 1', a: 'R', color: '#8b5cf6', text: 'Al principio tenía miedo de no entender los términos clínicos. La terapeuta y el sistema de reportes lo explican todo de manera muy sencilla. Me siento acompañada.' },
  ]
  ...
  const benefits = [
    ...
    { icon: <Shield size={20} color="#fff" />, bg: 'linear-gradient(135deg,#059669,#10b981)', title: 'Protected data', desc: '100% secure information with clinical standards.' },
  ]
...
@media(min-width:640px){ .lp-map-section { height: 500px; } .lp-map-card { position: absolute; top: 50%; left: 48px; transform: translateY(-50%); border-radius: 22px; box-shadow: 0 24px 60px rgba(0,0,0,.15); max-width: 360px; } }
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{ fontFamily: "'Baloo 2',cursive", fontSize: 'clamp(26px,4vw,46px)', fontWeight: 800, color: '#1c1917', lineHeight: 1.15, marginBottom: 12 }}>
              {"Meet"} <span style={{ color: '#f97316' }}>ARIA</span>
            </h2>
      ...
      <section id="servicios" className="lp-section" style={{ background: '#fffbf5' }}>
        <div className="lp-inner">
          <div style={{ textAlign: 'center', marginBottom: 52 }}>
            <div className="lp-tag"><Star size={12} /> {"Our Services"}</div>
          ...
          <div className="lp-grid-3">
            ...
            <div className="lp-svc-card featured">
              ...
              <a href={waUrl} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 5, color: '#fff', fontFamily: "'Baloo 2',cursive", fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>{"Contact us"} <ArrowRight size={15} /></a>
            </div>
            <div className="lp-svc-card">
      ...
      {false && <section className="lp-section" style={{ background: '#fff7ed' }}>
        <div className="lp-inner">
          <div style={{ textAlign: 'center', marginBottom: 52 }}>
            <div className="lp-tag"><Heart size={12} /> {"Our Team"}</div>
      ...
      <section id="faq" className="lp-section" style={{ background: '#fffbf5' }}>
        <div className="lp-inner" style={{ maxWidth: 760 }}>
          ...
          {[
            { q: 'What age can therapy start?', a: 'We work with children from 1 year old onwards. Early intervention is key. Our team adapts sessions to the age and needs of each child.' },
            { q: 'How can I get started?', a: 'Very simple. Contact us via WhatsApp and our team will guide you through the admission process and the services best suited to your child\'s needs.' },
