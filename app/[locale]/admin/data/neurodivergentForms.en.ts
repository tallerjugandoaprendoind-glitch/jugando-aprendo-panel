  ...
  sections: [
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'contextos', label: 'In which contexts do they occur?', type: 'multiselect', options: ['Casa', 'Escuela/Colegio', 'Con otros niños', 'En lugares públicos', 'En todos los contextos'] },
        { id: 'evaluacion_previa', label: 'Has had prior evaluation or diagnosis?', type: 'select', options: ['No', 'Sí - sin diagnóstico formal', 'Sí - diagnóstico de TDAH Inatento', 'Sí - diagnóstico de TDAH Hiperactivo-Impulsivo', 'Sí - diagnóstico de TDAH Combinado'] },
  ...
  sections: [
    {
      ...
      questions: [
        ...
        { id: 'hora_dormir', label: 'How is bedtime?', type: 'select', options: ['Sin problemas', 'Tarda en dormirse', 'Se levanta repetidamente', 'Muy difícil - gran resistencia', 'Muy poco sueño'] },
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        { id: 'estrategias_funcionan', label: 'What strategies work for you?', type: 'textarea', placeholder: 'Describe qué cosas ayudan a manejar su conducta...' },
        ...
        { id: 'ayuda_necesaria', label: '¿En qué aspecto necesitan más ayuda como familia?', type: 'textarea', placeholder: 'Tell us how we can best support you...' },
      ]
    }
  ]
}
  ...
  sections: [
    {
      ...
      questions: [
        ...
        { id: 'tea_mostrar_objetos', label: 'Shows objects to others to share', type: 'select', options: ['Yes, usually', 'Sometimes', 'Rarely', 'No'] },
        { id: 'tea_juego_imitativo', label: 'Imitates actions of other people', type: 'select', options: ['Yes, spontaneously', 'When prompted', 'Rarely', 'Does not imitate'] },
    ...
    },
    {
      ...
      questions: [
        { id: 'tea_hipersensibilidad_auditiva', label: 'Auditory hypersensitivity (covers ears, gets distressed)', type: 'frequency', options: FREQ_OPTIONS },
    ...
    },
    {
      ...
      questions: [
        { id: 'tea_edad_primeras_preocupaciones', label: 'Age when first concerns were noted', type: 'text', placeholder: 'E.g.: 18 months, 2 years...' },
        ...
        { id: 'tea_diagnostico_previo', label: 'Does the child have a prior diagnosis?', type: 'select', options: ['No', 'ASD level 1 (formerly Asperger)', 'ASD level 2', 'ASD level 3', 'ASD unspecified', 'Other PDD'] },
        { id: 'tea_nivel_funcionamiento', label: 'Estimated general functioning level', type: 'select', options: ['High - independent life possible', 'Medium - requires some support', 'Low - requires significant support', 'Very low - requires full support'] },
        ...
        { id: 'tea_observaciones', label: 'Evaluator Clinical Observations', type: 'textarea', placeholder: 'Notes on behavior during the session, diagnostic impression...' },
      ]
    }
  ]
}
...
export const CONDUCTA_CASA_TEA: FormDefinition = {
  ...
  targetRole: 'parent',
  estimatedMinutes: 20,
  description: 'Tell us what your child is like at home. This information helps us personalize therapy better.',
  ...
  sections: [
    {
      ...
      questions: [
        { id: 'como_comunica', label: 'How does your child primarily communicate?', type: 'multiselect', options: ['Single words', 'Short phrases', 'Complete sentences', 'Gestures and signs', 'Pictograms/PECS', 'Tablet/device', 'Pointing to objects', 'Leading the adult', 'Crying or vocalizations'] },
        { id: 'palabras_funcionales', label: 'Approximately how many functional words does the child use?', type: 'select', options: ['Does not use words', '1-10 words', '11-50 words', '51-100 words', 'More than 100 words'] },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'alimentacion', label: 'How is feeding/eating?', type: 'textarea', placeholder: 'Describe which foods the child accepts, textures rejected, mealtimes, etc.' },
        { id: 'sueño', label: 'How is sleep?', type: 'select', options: ['Sleeps well', 'Difficulty initiating sleep', 'Wakes up frequently', 'Very little total sleep', 'Very disrupted sleep patterns'] },
      ]
    },
    {
      title: '3. What Brings Us Joy and Concerns Us',
      ...
      questions: [
        ...
        { id: 'mayor_preocupacion', label: 'What is your biggest concern right now?', type: 'textarea', placeholder: 'Tell us what worries you most as a parent...' },
        ...
        { id: 'apoyo_familia', label: 'What support do you receive as a family?', type: 'multiselect', options: ['Partner support', 'Grandparent support', 'Support from parents of similar children', 'Support group', 'Psychologist/therapist for the family', 'None currently'] },
      ]
    }
  ]
}
...
export const PERFIL_SENSORIAL: FormDefinition = {
  ...
  targetRole: 'admin',
  estimatedMinutes: 20,
  description: 'Evaluates how each sensory system is processed: hyper/hyposensitivity, sensory seeking and avoidance.',
  ...
  sections: [
    {
      ...
      questions: [
        ...
        { id: 'aud_volumen', label: 'Speaks very loudly or softly without noticing', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'aud_busqueda', label: 'Seeks sounds or makes repetitive noises', type: 'frequency', options: FREQ_OPTIONS },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'vis_lineas', label: 'Looks at objects sideways or very closely', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'olf_olores', label: 'Hypersensitive to smells (moves away, disgust expression)', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'olf_huele', label: 'Smells objects or people in an unusual way', type: 'frequency', options: FREQ_OPTIONS },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'vest_busca', label: 'Seeks spinning, swinging, excessive movement', type: 'frequency', options: FREQ_OPTIONS },
    ...
    },
    {
      ...
      questions: [
        { id: 'sens_participa_actividades', label: 'Does the child avoid activities for sensory reasons?', type: 'multiselect', options: ['Contact sports', 'Art/crafts', 'Music/concerts', 'Eating at restaurants', 'Crowded public places', 'Shopping malls', 'Public transport', 'None'] },
        { id: 'sens_melts', label: 'Does the child have meltdowns or sensory overload?', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'sens_duracion_colapso', label: 'Typical duration of a sensory overload episode', type: 'select', options: ['No meltdowns', 'Less than 5 minutes', '5-15 minutes', '15-30 minutes', 'More than 30 minutes'] },
        { id: 'sens_regulacion', label: 'What helps the child self-regulate?', type: 'textarea', placeholder: 'Describe what strategies regulate overload episodes...' },
      ]
    }
  ]
}
  ...
  sections: [
    {
      ...
      questions: [
        { id: 'hs_inicia', label: 'Initiates conversations or games with peers', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'hs_saluda', label: 'Greets and says goodbye appropriately', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'hs_mantiene', label: 'Maintains the topic of conversation', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'hs_turno', label: 'Respects conversational turn-taking', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'hs_contexto', label: 'Adapts language to context and interlocutor', type: 'select', options: ['Yes, appropriately', 'Sometimes', 'Rarely', 'Does not do it'] },
    ...
    },
    {
      ...
      questions: [
        ...
        { id: 'em_estrategias', label: 'What emotional regulation strategies does the child use?', type: 'textarea', placeholder: 'Breathes, asks for help, walks away, has a regulatory object...' },
      ]
    },
    {
      ...
      questions: [
        ...
        { id: 'juego_tipo', label: 'Predominant type of play', type: 'select', options: ['Solitary', 'Parallel (near others but not interacting)', 'Associative (briefly interacts)', 'Cooperative (team play with rules)'] },
        { id: 'juego_reglas', label: 'Accepts and follows game rules', type: 'frequency', options: FREQ_OPTIONS },
        { id: 'juego_perder', label: 'Tolerates losing or things not going as wanted', type: 'select', options: INTENSITY_OPTIONS },
      ]
    }
  ]
}
  ...
  sections: [
    {
      ...
      questions: [
        ...
        { id: 'practica_casa', label: 'Did you practice the recommended strategies?', type: 'select', options: ['Yes, every day', 'Most days', 'Some days', 'Barely managed', 'Could not / did not remember'] },
        ...
        { id: 'estado_animo_hijo', label: 'How was your child\'s mood?', type: 'select', options: ['Very cheerful and calm', 'Good in general', 'Variable', 'More irritable than usual', 'Very difficult'] },
  ...
  sections: [
    {
      ...
      questions: [
        { id: 'fam_composicion', label: 'Who does the child live with?', type: 'multiselect', options: ['Father', 'Mother', 'Siblings', 'Grandparents', 'Other relatives', 'With only one parent'] },
        ...
        { id: 'fam_idioma', label: 'What language(s) are spoken at home?', type: 'text', placeholder: 'E.g.: Spanish, also speak Quechua...' },
        { id: 'fam_situacion', label: 'What is the current family situation?', type: 'select', options: ['Stable, no significant events', 'Recent change (move, job)', 'Recent separation or divorce', 'Recent family loss', 'Difficult financial situation', 'Other important change'] },
      ]
    },
    {
      ...
      questions: [
        ...
        { id: 'emb_semanas', label: 'At how many weeks was the child born?', type: 'select', options: ['Extremely premature (<28 wk)', 'Very premature (28-32 wk)', 'Late premature (33-36 wk)', 'Full term (37-42 wk)', 'Post-term (>42 wk)'] },
        { id: 'nac_peso', label: 'How much did the child weigh at birth?', type: 'text', placeholder: 'E.g.: 3.200 kg' },
    ...
    },
    {
      ...
      questions: [
        { id: 'hito_sonrisa', label: 'At what age did the child first social smile?', type: 'text', placeholder: 'E.g.: 2 months' },
        { id: 'hito_sento', label: 'At what age did the child sit alone?', type: 'text', placeholder: 'E.g.: 6 months' },
        { id: 'hito_camino', label: 'At what age did the child walk alone?', type: 'text', placeholder: 'E.g.: 12-14 months' },
        { id: 'hito_palabras', label: 'At what age did the child say their first words?', type: 'text', placeholder: 'E.g.: 12 months' },
        { id: 'hito_frases', label: 'At what age did the child combine two words?', type: 'text', placeholder: 'E.g.: 24 months' },
        { id: 'hito_control', label: 'At what age did the child achieve toilet training?', type: 'select', options: ['Before 2 years', '2-3 years', '3-4 years', 'After 4 years', 'Not yet achieved'] },
        { id: 'hito_preocupaciones', label: 'When did you start to have concerns?', type: 'textarea', placeholder: 'Describe when and what you noticed...' },
      ]
    },
    {
      title: '4. Health and Medical History',
      questions: [
        { id: 'med_enfermedades', label: 'Has the child had significant illnesses?', type: 'textarea', placeholder: 'Hospitalizations, surgeries, chronic illnesses...' },
        { id: 'med_medicacion', label: 'Is the child currently taking any medication?', type: 'textarea', placeholder: 'Name, dose, what it is for...' },
        ...
        { id: 'med_oftalmologia', label: 'Has vision been evaluated?', type: 'select', options: ['Yes - normal vision', 'Yes - wears glasses', 'Not evaluated'] },
