...
export default function KnowledgeBaseView() {
  ...
  const temasSugeridos = [
    ...
    isEN ? 'Functional behavior analysis' : 'Análisis funcional de conducta',
    isEN ? 'Autism social skills' : 'Habilidades sociales autismo',
    'Impulse control ADHD',
    'Shaping ABA',
    isEN ? 'Daily living skills training' : 'Entrenamiento de habilidades diarias',
    isEN ? 'Emotional regulation children' : 'Regulación emocional niños',
    'ABA play therapy',
    isEN ? 'Verbal behavior language' : 'Lenguaje verbal comportamental',
