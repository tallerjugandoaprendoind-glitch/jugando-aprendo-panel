        ...
        <div className="xl:col-span-4 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
            <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-3">
              ...
              <span className="text-xs font-black px-2.5 py-1 rounded-full bg-slate-100 text-slate-500 flex-shrink-0">
                    ...
                    return (
                      <div key={c.id} className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-black truncate text-slate-800">{c.service_type || c.type || 'Terapia ABA'}</p>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex-1">
            <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-3">
              ...
              <h3 className="font-black text-sm flex-1 text-slate-800">Próximas sesiones</h3>
              <span className="text-xs font-black px-2 py-0.5 rounded-full border bg-slate-50 text-slate-400 border-slate-100">
