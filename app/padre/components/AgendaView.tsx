...
const ST: Record<string,{label:string;dot:string;bg:string;text:string;border:string;Icon:any}> = {
  ...
  pending:   { label:'Pendiente',  dot:'#f59e0b', bg:'#fffbeb', text:'#b45309', border:'#fde68a', Icon:AlertCircle },
  cancelled: { label:'Cancelada',  dot:'#ef4444', bg:'#fef2f2', text:'#dc2626', border:'#fecaca', Icon:XCircle },
  completed: { label:'Completada', dot:'#6366f1', bg:'#f5f3ff', text:'#4338ca', border:'#ddd6fe', Icon:CheckCircle2 },
}
